<%-- 
    Document   : Administracion-Choferes
    Created on : 25 jun. 2023, 01:38:51
    Author     : MICHAEL
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <script src="../FUNCIONES/datatable.js" type="text/javascript"></script>

        <!--VENTANA MODAL-->
        <script src="../FUNCIONES/active-modal.js" type="text/javascript"></script>
        <script src="../FUNCIONES/botones-modal.js"type="text/javascript" ></script>

        <script src="../FUNCIONES/active-dasboard.js" type="text/javascript"></script>
