...
<html>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="POST" method="POST" role="form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="accion" name="btnGuardar" class="btn btn-success btnOcultar">Guardar</button>
    ...
    <script src="../FUNCIONES/admin-panel.js"></script>
    <script src="FUNCIONES/mantenimientoChoferes.js" type="text/javascript"></script>
    </body>
</html>
